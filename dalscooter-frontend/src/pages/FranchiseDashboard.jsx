...
import { Plus, Edit3, Trash2, Search, MapPin, DollarSign, Battery, Zap, Eye, Calendar, BarChart3, MessageCircle, Bike } from "lucide-react"
...
function FranchiseDashboard() {
  ...
  // Tab configuration
  const tabs = [
    { id: 'bikes', label: 'Manage Bikes', icon: Bike },
    { id: 'analytics', label: 'Analytics Dashboard', icon: BarChart3 },
    { id: 'feedback', label: 'Customer Feedback', icon: MessageCircle }
  ];
  ...
  // Fixed filteredBikes function - searches across multiple fields
  const filteredBikes = bikes.filter((bike) => {
    if (!searchTerm) return true;
    
    const searchLower = searchTerm.toLowerCase();
    const matchesAccessCode = bike.access_code?.toLowerCase().includes(searchLower);
    const matchesLocation = bike.location?.toLowerCase().includes(searchLower);
    const matchesBikeType = bike.bike_type?.toLowerCase().includes(searchLower);
    const matchesStatus = bike.status?.toLowerCase().includes(searchLower);
    
    return matchesAccessCode || matchesLocation || matchesBikeType || matchesStatus;
  }).filter((bike) => {
    if (!filterType) return true;
    return bike.bike_type === filterType;
  });
        ...
        <div className="container">
          ...
          <div className="header">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="header-subtitle">Manage your fleet, view analytics, and monitor feedback</p>
              </div>
            </div>
          </div>
                ...
                <div className="controls-inner">
                  ...
                  <div className="search-group">
                    <div className="search-container">
                      ...
                      <input
                        type="text"
                        placeholder="Search by code, location, type, or status..."
                        value={searchTerm}
          ...
          {activeTab === 'feedback' && (
            <div className="feedback-tab-content">
              ...
              <p>Customer feedback functionality is available on the main Feedback page for all users.</p>
              <button 
                onClick={() => navigate('/feedback')} 
                className="bike-card-button"
              >
